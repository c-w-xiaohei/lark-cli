...
# Search within a specific wiki space
./lark doc wiki-search "project plan" --space-id 7307457194084925443
...
Use the `obj_token` with `doc get` to retrieve the document content.
